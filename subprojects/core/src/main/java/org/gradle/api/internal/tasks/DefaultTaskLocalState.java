...
public class DefaultTaskLocalState implements TaskLocalStateInternal {
    ...
    private final List<Object> localState = Lists.newArrayList();
    ...
    public void register(final Object... paths) {
        taskMutator.mutate("TaskLocalState.register(Object...)", new Runnable() {
            @Override
            public void run() {
                Collections.addAll(localState, paths);
            }
        });
    }
    ...
    public FileCollection getFiles() {
        return new DefaultConfigurableFileCollection(task + " destroy files", resolver, null, localState);
    }
}
